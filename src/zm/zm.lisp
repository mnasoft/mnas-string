...
(defpackage #:mnas-string/zm
  ...
  (:documentation
   " Пакет @b(mnas-string/zm) определяет функцию
@b(sort-designation-zm) для сортировки обозначений применительно к
конструкторской документации выпускаемой на ZM.
"))

(in-package :mnas-string/zm)
