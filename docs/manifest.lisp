(:docstring-markup-format
   :scriba
   :systems (:MNAS-STRING :MNAS-STRING/DOCS)
   :documents ((:title "Mnas-String"
	        :authors ("Nick Matvyeyev")
	        :output-format (:TYPE :MULTI-HTML :TEMPLATE :MINIMA) 
                :sources ("tmp.scr" "mnas-string.scr"
                          "mnas-string-translit.scr" "mnas-string-print.scr"
                          "mnas-string-parse.scr" "mnas-string-docs.scr"
                          "mnas-string-db.scr" "mnas-string-graph.scr"
                          "mnas-string-parse-graph.scr"
                          "mnas-string-print-graph.scr"
                          "mnas-string-translit-graph.scr"
                          "mnas-string-db-graph.scr"
                          "mnas-string-docs-graph.scr")
                )))